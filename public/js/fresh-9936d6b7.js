$(function(){
  ...
  $('#signup-merchant-form').on('submit', function(e){
    ...
    let visitors = $('select[name="visitors"]').val();
    let business = $('textarea[name="business"]').val();
    ...
    fetch(`https://rtc-app.herokuapp.com/subscriptions/merchants/?email=${email.trim()}`, options)
    .then((response) => {
      return response.json();
    })
    .then((data) => {
