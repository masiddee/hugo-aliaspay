$(function(){
  ...
  $('#signup-merchant-form').on('submit', function(e){
    ...
    .then((data) => {
      if(data.success === true){
        $('.loader').remove();              
        $(this).html(`<p class="signup-merchant-success"></p>`);
        $(this).html(`<article class="message is-success">
                        <div class="message-header">
                          <p>Success!</p>
                        </div>
                        <div class="message-body">
                          Thanks for requesting early access! Look for a follow up email from us to complete the registration process, and to get the WooCommerce plugin activated for your online shop.
                        </div>
                      </article>`
        );
      }
