$(function(){
  ...
  // CUSTOM CODE MS
  var featuresTop = $('#features-section').offset().top;
  var pricingTop = $('#pricing-section').offset().top;
  // var merchantsTop = $('#merchants-section').offset().top;
  //console.log(featuresTop.top);
