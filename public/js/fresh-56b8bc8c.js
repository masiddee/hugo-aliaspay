  ...
  $('.account-verify-btn').on('click', function(e){
    ...
    if(q != undefined) {
      ...
      .then((data) => {
        if(data.success === true){
          ...
          $(this).html(`<article class="message is-success">
                          ...
                          <div class="message-body">
                            <p>Please return to the Alias Pay app to add your fiest Alias Card.</p>
                          </div>
                        </article>`
          );
        }
      ...
      $(this).html(`<article class="message is-danger">
                        ...
                        <div class="message-body">
                          <p>We were unable to find an account ID for your...</p> <br>
                          <p>Please resend the account verification link and try to verify again.</p> <br>
                          <p>If this still does not work, please contact us at info@aliaspay.io for additional assistance.</p>
                        </div>
                      </article>`
      );
    }
